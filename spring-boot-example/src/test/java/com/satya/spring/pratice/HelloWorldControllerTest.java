package com.satya.spring.pratice;
...
public class HelloWorldControllerTest {
	...
	@Test
	public void shouldReturn200WhenSendingRequestToControllerJ() throws Exception {
		@SuppressWarnings("rawtypes")
		ResponseEntity<Map> entity = this.testRestTemplate.getForEntity(
				"http://localhost:" + this.port + "/hello-world", Map.class);
		...
		@Test
		public void shouldReturWhenSendingRequestToController() throws Exception {
			@SuppressWarnings("rawtypes")
			ResponseEntity<Map> entity = this.testRestTemplate.getForEntity(
